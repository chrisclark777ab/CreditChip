...
if(empty($item))
{
header("Location: http://www.credit-chip.com/setup-3.php");
}
else
{
$_SESSION['item'] = $item
...
<title>Credit Chip | Setup 4</title>
<link href="css/setup-4.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <form action="http://www.credit-chip.com/setup-5.php" id="signupForm" method="post">
     <div id="marketprice">
       <label>
         <textarea name="description" id="description" placeholder="E.g. It's fully loaded and everything!" width="1000" cols="80" rows="5"></textarea>
       </label>
     </div>
     <div id="browse">
       <label>
