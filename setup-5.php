...
{
header("Location: http://www.credit-chip.com/setup-4.php");
}
else
{
...
<title>Credit Chip | Setup 5</title>
...
<div id="wrapper">
  ...
  <form action="http://www.credit-chip.com/setup-6.php" id="signupForm" method="post">
     <div id="marketprice">
       <label>
         <input type="text" width="1000" name="price" placeholder="E.g. 3200000" id="price" />
       </label>
     </div>
     <div id="browse">
       <label>
