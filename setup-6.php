...
if(!is_numeric($price))
{
header("Location: http://www.credit-chip.com/setup-5.php");
}
else
{
if(empty($price))
...
<title>Credit Chip | Setup 6</title>
<link href="css/setup-6.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box"> 
     <div id="titlebox">photo of item.</div>
  <form action="http://www.credit-chip.com/finish.php" id="signupForm" method="post" enctype="multipart/form-data">
     <div id="marketprice"><input type="file" name="fileToUpload" id="fileToUpload"></div>
     <div id="browse">
       <label>
