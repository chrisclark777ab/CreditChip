...
<title>Credit Chip | Forgot Password</title>
<link href="css/forgot_password.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box">
     <div id="topic"> 
       <div id="b">Forgot Password ?</div>
       </div>
     <div id="emailtite">
       <div id="b">Email</div></div>
     <div id="emailbox"><form action="http://www.credit-chip.com/get_password.php" id="signupForm" method="post">
       <div id="txtbox"><input type="text" name="email" maxlength="500" placeholder="E.g. name@domain.com" id="email" /></div>
     </div>
     <div id="joinbutton">
       <div id="but"><input type="image" src="http://www.credit-chip.com/img/recover.png" name="image" width="138" height="58"></div>
     </div></form>
   </div>
  </div>
