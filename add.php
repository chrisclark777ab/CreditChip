...
<title>Anti-Coin | Add</title>
<link href="css/add.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box">
     <div id="titlebox">Add an item.</div>
  <form action="https://www.anti-coin.com/add-2.php" id="signupForm" method="post">
     <div id="marketprice">
       <label>
