...
<title>Anti-Coin | Checkout 2</title>
<link href="css/checkout-2.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box">
     <div id="titlebox">Please add your email address.</div>
 <?PHP  

 echo'<form action="http://www.credit-chip.com/checkout-3.php'; echo '?id='; echo $_GET['id']; 
echo'" id="signupForm" method="post">'; ?>
     <div id="marketprice">
       <label>
         <textarea name="contact" id="contact" placeholder="E.g. johndoe@gmail.com" cols="80" width="1000" rows="5"></textarea>
       </label>
     </div>
     <div id="browse">
       <label>
