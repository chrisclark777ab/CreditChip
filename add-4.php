...
if(empty($price))
{
header("Location: https://www.anti-coin.com/add-3.php");
}
else
{
...
<title>Anti-Coin | Add 4</title>
<link href="css/add-4.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box"> 
     <div id="titlebox">Item photo.</div>
  <form action="https://www.anti-coin.com/added.php" id="signupForm" method="post" enctype="multipart/form-data">
