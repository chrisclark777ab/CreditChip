...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box">
     <div id="titlebox">Store</div>
   <form action="https://www.anti-coin.com/setup-1.php" id="signupForm" method="post">
     <div id="marketprice"><a class="blue" href="https://www.anti-coin.com/setup.php"><input type="image" src="https://www.anti-coin.com/img/create.png" name="image" width="138" height="58"></a></div>
     <div id="browse"></div>
   </div></form>
  </div>
