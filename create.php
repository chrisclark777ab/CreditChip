...
<title>Credit Chip | Create</title>
...
<div id="wrapper">
  ...
  <div id="cube">
   <div id="box">
     ...
     <div id="marketprice"><a class="blue" href="http://www.credit-chip.com/setup-1.php"><input type="image" src="http://www.credit-chip.com/img/create.png" name="image" width="138" height="58"></a></div>
     <div id="browse"></div>
   </div>
  </div>
