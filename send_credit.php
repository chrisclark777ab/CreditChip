...
<title>Anti-Coin | Send Credit</title>
<link href="css/send_credit.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  <div id="header">
    ...
    <div id="rightcol1"><strong><a class="white" href="https://www.anti-coin.com/signin.php">Sign in</a> | <a class="white" href="https://www.anti-coin.com/signup.php">Sign up</a></strong></div>
  </div>
  ...
  <div id="cube">
   <div id="box">
     <div id="topic"> 
       <div id="b">Send Credit</div>
       </div>
     <div id="emailtite">
       <div id="b">Email</div></div>
     <div id="emailbox"><form action="https://www.anti-coin.com/get_send.php" id="signupForm" method="post">
       <div id="txtbox"><input type="text" name="email" maxlength="500" placeholder="E.g. name@domain.com" id="email" /></div>
     </div>
     <div id="joinbutton">
       <div id="but"><input type="image" src="https://www.anti-coin.com/img/send.png" name="image" width="138" height="58"></div>
     </div></form>
   </div>
  </div>
